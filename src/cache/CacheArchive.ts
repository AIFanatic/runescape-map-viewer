...
import { CacheFile } from './ClientData';
...
export class CacheArchive {
    ...
    private decompress(data: StreamBuffer): StreamBuffer {
    ...
    public getFileData(fileName: string): StreamBuffer | null {
